...
def update_metrics():
    with metrics_placeholder.container():
        ...
        st.write(f"<div>Last Update: <span id='last_update'></span></div>", unsafe_allow_html=True)
        ...
        <script>
            function updateTime() {{
                try {{
                    ...
                    // Local time ko screen par dikhana
                    document.getElementById('last_update').innerText = localDate.toLocaleString();
                }} catch (e) {{
                    // Agar koi error aaye to console mein dikhao
                    console.error("Error updating time: ", e);
                    document.getElementById('last_update').innerText = "Error";
                }}
            }}
